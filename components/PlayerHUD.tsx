    ...
    <div className="fixed bottom-10 left-1/2 -translate-x-1/2 z-50 w-full max-w-md px-6">
      ...
      >
        <div className="flex items-center gap-5">
          {/* Cover Art from Suno CDN */}
          <img 
            src={currentTrack.coverArt} 
            className="h-16 w-16 rounded-2xl shadow-lg border border-white/10 object-cover" 
            alt="Song Art" 
          />
          ...
          <div className="flex items-center gap-3">
            ...
            <button 
              ...
              className="bg-white p-3 rounded-full text-black hover:scale-110 active:scale-95 transition-all"
            >
